...
class ConfigGenerator:
    """Build and generate a configuration file
    """
    ...
    def save(self, filename: str) -> None:
        with open(filename, 'rw', encoding='utf-8') as file:
            file.write("# File generated by HHFC\n\n")
            file.write(yaml.dump(self.config))

    def add_fan_configuration(self, fan_config: dict) -> None:
        self.config["FANS"].append(fan_config)
